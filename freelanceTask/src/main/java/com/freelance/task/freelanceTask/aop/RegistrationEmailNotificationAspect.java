...
@Aspect
@Component
public class RegistrationEmailNotificationAspect {
    ...
    @Async
    @AfterReturning(value = "execution(* com.freelance.task.freelanceTask.services.DriverService.createDriver(..))", returning = "driver")
